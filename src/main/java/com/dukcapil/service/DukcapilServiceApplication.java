...
public class DukcapilServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("📊 Health Check: http://localhost:8080/api/dukcapil/health");
        System.out.println("📋 API Docs: http://localhost:8080/api/dukcapil/docs");
        System.out.println("🔍 Main Endpoint: POST http://localhost:8080/api/dukcapil/verify-nik");
        System.out.println("📈 Statistics: http://localhost:8080/api/dukcapil/stats");
        System.out.println("");
